...
$(document).ready(function () {
  ...
  if ($("#sales_chart").length > 0) {
    var columnCtx = document.getElementById("sales_chart"),
      columnConfig = {
        colors: ["#131b37", "#8fceff"],
        series: [
          {
            name: "รับยาเข้าคลัง",
            type: "column",
            data: [
              6000, 6500, 7000, 7500, 9000, 8500, 9000, 10000, 12000, 9000,
              10000
            ],
          },
          {
            ...
            type: "column",
            data: [
              4815, 5262, 5655, 7263, 6223, 7595, 8156, 8612, 10043, 9107, 9521
            ],
          },
        ],
        chart: {
        ...
        stroke: { show: true, width: 2, colors: ["#dedede"] },
        xaxis: {
          categories: [
            "มกราคม",
            "กุมภาพันธ์",
